	...
	return (
		<>
			<Button
				...
				className="absolute top-0 right-0 z-50 rounded-xl rounded-tl-none rounded-br-none border border-(--border-color) bg-(--bg-secondary) p-2 shadow-md backdrop-blur-md lg:hidden"
				variant="custom"
